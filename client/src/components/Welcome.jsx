...
const Welcome = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // prevents the default action of the page reloading when the form is submitted
    e.preventDefault();

    // leaves function without submitting the form if any of the following are true
